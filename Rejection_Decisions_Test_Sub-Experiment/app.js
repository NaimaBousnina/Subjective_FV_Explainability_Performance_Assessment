async function main() {
    ...
    const uri = 'mongodb://localhost:27017/test_2';
    ...
    app.get('/train_2', (req, res) => {
        Trains.findOne(function(err, pair) {
            if (err || pair == null){
                ...
                res.render('train_2', {Probe_img: './public/images/train/Probe/Probe_2.jpg', Gallery_img : './public/images/train/Gallery/Gallery_2.jpg', First_HM : './public/images/train/HM_1/HM1_2.png', Second_HM : './public/images/train/HM_2/HM2_2.png',
                });
            }
        })
    })
